...
-   Rule 5: Use the imperative mood[^hw-01-pet-names-1] in the subject line: **Complete** Exercise 6
...
Why can't I write whatever I want?[^hw-01-pet-names-2]
...
**Thought exercise:** Which of the above steps (updating the YAML, committing, and pushing) needs to talk to GitHub?[^hw-01-pet-names-3]
...
[^hw-01-pet-names-1]: Spoken or written as if giving a command or instruction, e.g. "Clean your room!"

[^hw-01-pet-names-2]: There's nothing stopping you from writing what you want in a commit message.
...
[^hw-01-pet-names-3]: Only pushing requires talking to GitHub, this is why you're asked for your password at that point.
