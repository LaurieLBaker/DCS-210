---
title: "Doing data science refresher"
subtitle: "<br><br> College of the Atlantic"
author: "[https://coa-data-analysis.netlify.app/](https://coa-data-analysis.netlify.app/)"
output:
...
```{r easy-solution, message = FALSE, warning = FALSE, fig.show = "hide"}
squirrels <- squirrels %>%
...
.panel[.panel-name[Plot]
```{r ref.label="hex-plot", message = FALSE, warning = FALSE, echo = FALSE}
```
]

.panel[.panel-name[Code]
```{r hex-plot, message = FALSE, warning = FALSE,fig.show = "hide"}
