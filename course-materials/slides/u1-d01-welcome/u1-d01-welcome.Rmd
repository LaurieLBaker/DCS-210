---
title: "Welcome!"
subtitle: "<br><br> Programming for Data Analysis and Visualization"
author: "Dr. Laurie Baker, [DCS 210](https://vigorous-sammet-f57077.netlify.app/)"
output:
...
#### Call me: "Dr. Baker", "Professor Baker"
...
`r icons::fontawesome("desktop")` Head of Faculty, Data Science Campus, Office for National Statistics
...
```{r echo=FALSE, out.width="70%", fig.align="center", fig.cap = "Grey seal (Halichoerus grypus) with GPS tag on back of neck and acoustic tag on back"}
...
```{r echo=FALSE, out.width="70%", fig.align="center", fig.cap = "Map showing rabies retreat from Western Europe"}
knitr::include_graphics("img/rabies_retreat.png")
```

---

# Building Organization's Data Science Skills

```{r echo=FALSE, out.width="70%", fig.align="center", fig.cap = "Icons showing United Nation's 17 Sustainable Development Goals"}
knitr::include_graphics("img/SDGs.png")
```
...
---
# Data Storytelling: Rabies Elimination on Pemba

<iframe src="https://rabiesresearch.github.io/pemba_story/" width="1016" height="480" frameBorder="0"></iframe>
...
[https://vigorous-sammet-f57077.netlify.app/](https://vigorous-sammet-f57077.netlify.app/)
