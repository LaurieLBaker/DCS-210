...
```{r}
title <- speech_page %>%
  html_element(".ds_page-header__title") %>%
  html_text()
...
.pull-right-narrow[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("img/covid_date.jpg")
```
]
...
location <- speech_page %>%
  html_element(".ds_metadata__item:nth-child(5) strong") %>%
  html_text()
...
.pull-right-narrow[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("img/covid_location.jpg")
```
]
...
abstract <- speech_page %>%
  html_element(".ds_no-margin--bottom") %>%
  html_text()
...
.pull-right-narrow[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("img/covid_abstract.jpg")
```
]
