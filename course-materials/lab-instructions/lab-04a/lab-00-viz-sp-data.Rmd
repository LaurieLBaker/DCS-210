...
11. Filter the data for observations in North Carolina only, and recreate the leaflet plot.
...
12. Now filter the data for observations in Texas only, and recreate the leaflet plot, with an appropriate `alpha` level.
    Visually, does Mitch Hedberg's joke appear to hold here?
