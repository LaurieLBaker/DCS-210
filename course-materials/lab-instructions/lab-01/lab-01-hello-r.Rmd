...
## Introduce yourself to Git
 ...
 Once you've opened up RStudio Cloud, we will want to introduce ourselves to Git. This is perhaps the most tedious part of the process as you have to (re)introduce yourself to git *every time you make a new project*.
...
use_git_config(user.name = "Laurie Baker", user.email = "lbaker@bates.edu") # Enter your name and email.
