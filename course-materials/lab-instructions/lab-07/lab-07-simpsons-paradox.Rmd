---
title: "Lab 00 - Smokers in Whickham"
...
Click on the assignment link clone it in Posit and open the R Markdown document.
...
You can find out more about the dataset by inspecting their documentation, which you can access by running `?Whickham` in the Console or using the Help menu in Posit to search for `Whickham`.
...
6.  Create a new variable called `age_cat` using the following scheme. Hint you'll want to think about using `if_else` or `case_when` here:
